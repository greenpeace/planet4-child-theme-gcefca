...
class MasterSite extends TimberSite {
	...
	public function add_to_context( $context ) {
		...
		$context['data_nav_bar'] = [
			...
			'dropdown_toggle' => __( 'Toggle worldwide site selection menu', 'planet4-master-theme' ),
    ...
    $context['lang'] = strtolower( self::generate_hreflang_meta());
